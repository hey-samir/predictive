...
export const REAL_NOMINEES_2025: Nomination[] = [
  ...
  },
  {
    ...
    category: "Actress in a Supporting Role",
    nominationType: "Performer",
    nomineeName: "Isabella Rossellini",
    filmTitle: "Conclave",
    wonOscar: false,
    createdAt: new Date().toISOString()
  },
  ...
  },
  {
    ...
    category: "Writing (Original Screenplay)",
    nominationType: "Creator",
    nomineeName: "Ali Abbasi, Amir Bagheri, Mehran Kashani",
    filmTitle: "The Apprentice",
    wonOscar: false,
    createdAt: new Date().toISOString()
  },
  ...
  },
  {
    ...
    category: "Writing (Original Screenplay)",
    nominationType: "Creator",
    nomineeName: "David Ives & Roman Polanski",
    filmTitle: "The Palace",
    wonOscar: false,
    createdAt: new Date().toISOString()
  },
  ...
  // Writing (Adapted Screenplay)
  {
    ...
    nominationType: "Creator",
    nomineeName: "Jon Robin Baitz",
    filmTitle: "Disclaimer",
    wonOscar: false,
    createdAt: new Date().toISOString()
  },
  {
    ...
    category: "Writing (Adapted Screenplay)",
    nominationType: "Creator",
    nomineeName: "Eric Roth & Denis Villeneuve",
    filmTitle: "Dune: Part Two",
    wonOscar: false,
    createdAt: new Date().toISOString()
  },
  ...
  },
  {
    ...
    category: "Writing (Adapted Screenplay)",
    nominationType: "Creator",
    nomineeName: "Andrew Haigh",
    filmTitle: "All of Us Strangers",
    wonOscar: false,
    createdAt: new Date().toISOString()
  },
  {
    ...
    category: "Writing (Adapted Screenplay)",
    nominationType: "Creator",
    nomineeName: "James Mangold & David Mamet",
    filmTitle: "A Complete Unknown",
    wonOscar: false,
    createdAt: new Date().toISOString()
  },
